...
int RGWRados::fix_head_obj_locator(rgw_bucket& bucket, bool copy_obj, bool remove_bad, rgw_obj_key& key)
{
  ...
  op.stat2(&size, (ceph_real_time_t *)&mtime, NULL);
#define HEAD_SIZE 512 * 1024
  ...
  if (copy_obj) {
    ...
    wop.mtime2((ceph_real_time_t *)&mtime);
...
#define COPY_BUF_SIZE (4 * 1024 * 1024)
  ...
  do {
    ...
    if (ofs == 0) {
      rop.stat2(&size, (ceph_real_time_t *)&mtime, NULL);
    }
                  ...
                  map<string, bufferlist>& attrs)
{
  ...
  op.mtime2((ceph_real_time_t *)&meta.set_mtime);
              ...
              real_time set_mtime /* 0 for don't set */)
{
  ...
  op.mtime2((ceph_real_time_t *)&set_mtime);
  op.write_full(data);
...
int RGWRados::Object::Stat::stat_async()
{
  ...
  librados::ObjectReadOperation op;
  op.stat2(&result.size, (ceph_real_time_t *)&result.mtime, NULL);
